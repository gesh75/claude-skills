...
description: Write articles, guides, blog posts, tutorials, and newsletters in a distinctive voice derived from supplied examples or brand guidance. Use when the user wants polished long-form content where voice consistency matters.
origin: ECC
---
...
If the user wants a specific voice, capture it from real examples (articles, newsletters, X posts, docs, launch notes, style guides) and extract rhythm, compression, punctuation habits, and what the writer avoids. If no references are given, default to a sharp operator voice: concrete, unsentimental, useful.

Full guidance — the Voice Capture Workflow, the Affaan / ECC Voice Reference, and the Banned Patterns list — lives in [reference/voice.md](reference/voice.md). This is the canonical voice reference; apply it whenever voice consistency matters.
