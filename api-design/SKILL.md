...
Per-language reference implementations (Next.js / TypeScript, Django REST Framework / Python, net/http / Go) of resource creation with schema validation, `201 Created`, `Location` header, and structured error responses live in `reference/implementations.md`.
