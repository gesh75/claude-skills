...
| Model | ID | Best For |
|-------|-----|----------|
| Opus 4.8 | `claude-opus-4-8` | Complex reasoning, architecture, research (most capable) |
...
Default to Sonnet 4.6 unless the task requires deep reasoning (Opus 4.8) or speed/cost optimization (Haiku 4.5). For production, prefer pinned snapshot IDs over aliases (e.g. `claude-haiku-4-5-20251001`).
