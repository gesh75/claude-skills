---
name: videodb
description: See, Understand, and Act on video and audio. Ingest from files, URLs, RTSP/live feeds, or desktop capture; index and search moments with timestamps and auto-clips; transcode, edit timelines (subtitles, overlays, dubbing, translation), generate media, and raise real-time stream alerts. Workflow detail in reference/*.md.
origin: ECC
