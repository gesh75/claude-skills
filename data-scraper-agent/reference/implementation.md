# Data Scraper Agent — Implementation Code

Full code for the scraper source, Gemini AI client, AI pipeline, feedback learning, storage, and orchestrator. Referenced from SKILL.md Steps 3-8.
...
**RSS feed pattern:**
```python
import defusedxml.ElementTree as ET  # defusedxml: safe drop-in, prevents XXE (pip install defusedxml)
