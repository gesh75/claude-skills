---
name: team-builder
description: Interactive agent picker for composing and dispatching a parallel multi-agent team. Use when you want to browse available agent personas and choose which ones to run for a task, or assemble an ad-hoc cross-domain team (e.g. security + architecture + SEO).
origin: community
---
