# UI Demo — Full Script Template

The complete Playwright recording script skeleton and run commands. Referenced from SKILL.md "Script Template". Paste the helper functions from `cursor-overlay.md` and `field-discovery.md` where indicated.
