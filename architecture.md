---
name: architecture
description: Worked software-architecture trade-off examples across project scales (solo MVP, growth-stage, enterprise). Use when choosing an architecture or weighing scalability, cost, and complexity trade-offs for a new system.
---
